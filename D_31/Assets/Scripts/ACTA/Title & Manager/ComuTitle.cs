...
public class ComuTitle : MonoBehaviour, IPointerClickHandler
{
    public ComuData data; // 해당 제목에 해당하는 데이터
    private TextMeshProUGUI titleText; // 제목 텍스트
    // public NewsManager newsManager;

    public GameObject post_panel; // 커뮤니티 패널
    public GameObject ScrapButton; // 커뮤니티 스크랩 버튼
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        {
            ComuManager comuManager = post_panel.GetComponent<ComuManager>();
            if (comuManager == null) 
            {
                ...
                // 패널 UI 채우기
                comuManager.GetSourceTitle(this);
